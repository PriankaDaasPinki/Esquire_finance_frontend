...
const PurchaseOrder = () => {
  ...
  const purchaseOrder = useRef();
  const handlePrint = () => {
    const printContents = purchaseOrder.current.innerHTML;
  ...
  return (
    <div className ="pe-3 pt-2 object-cover">
      ...
      <div className="container-lg mx-auto rounded-sm border-2 py-8" ref={purchaseOrder}>
